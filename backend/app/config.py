...
class Settings(BaseSettings):
    ...
    GEMINI_API_KEY_4: str = Field(default="")
    GEMINI_EXTRACTOR_API_KEY: str = Field(default="")
    GEMINI_QUESTION_GENERATOR_MODEL: str = Field(default="")
    GEMINI_QUESTION_CHAT_BOT: str = Field(default="")
    GEMINI_QUESTION_SUPREME: str = Field(default="")
    GEMINI_QUESTION_KEY: str = Field(default="")
    GEMINI_QUESTION_KEY_AD_1: str = Field(default="")
